...
<script type="text/javascript">
	...
	{        
	        startLoading();
	        new Ajax.Updater('mainAreaInternal', 'screen2_insert.php', {method: 'post', postBody:'content='+ id +''});
	        finishLoading();
...
{
$k='a'.$i.'-'.$j;
$result=mysql_query("SELECT * FROM Monday_booking WHERE  status='1'and no_book='$k' and screen='screen2'and time='$time' and day='$day'and movie='$mov' ")or die(mysql_error());
...
{
$k='b'.$i.'-'.$j;
$result=mysql_query("SELECT * FROM Monday_booking WHERE username='$name' and conform='$rand' and status='1'and no_book='$k' and screen='screen2'and time='$time' and day='$day'and movie='$mov' ")or die(mysql_error());
$info=mysql_num_rows($result);
if ($info==1) 
{
	$seat='seat1';
...
<div>
	<form class="confor" action="conform2.php" method="post">
		<input type="submit" name="screen2" value="Conform"/>
	</form> 
