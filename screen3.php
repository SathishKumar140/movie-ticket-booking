...
<script type="text/javascript">
	...
	{        
	        startLoading();
	        new Ajax.Updater('mainAreaInternal', 'screen3_insert.php', {method: 'post', postBody:'content='+ id +''});
	        finishLoading();
...
{
$k='a'.$i.'-'.$j;
$result=mysql_query("SELECT * FROM Monday_booking WHERE  status='1'and no_book='$k' and screen='screen3'and time='$time' and day='$day'and movie='$mov' ")or die(mysql_error());
...
{
$k='b'.$i.'-'.$j;
$result=mysql_query("SELECT * FROM Monday_booking WHERE username='$name' and conform='$rand' and status='1'and no_book='$k' and screen='screen3'and time='$time' and day='$day'and movie='$mov' ")or die(mysql_error());
$info=mysql_num_rows($result);
if ($info==1) 
{
	$seat='seat1';
...
<div>
	<form class="confor" action="conform3.php" method="post">
		<input type="submit" name="screen3" value="Conform"/>
	</form> 
